...
@Schema(description = "Detailed response containing project information with associated activities")
public record ProjectDetailResponse(
        ...
        @Schema(description = "List of activities associated with this project") List<ActivityResponse> activities,
